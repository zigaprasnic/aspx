<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="novice.aspx.cs" Inherits="Projekt.login" %>
					...
					<div>
						<div id="news" class="body">
							<div class="sidebar">
								...
								<ul>
									<li>
										<a href="news.aspx">2023 Bikini Contest Winners</a>
									</li>
									<li>
										<a href="news.aspx">Top 10 Diving Spots</a>
									</li>
									<li>
										<a href="news.aspx">Fishing ban to be implemented this year</a>
									</li>
									<li>
										<a href="news.aspx">Lifeguard saves child from drowning</a>
									</li>
								</ul>
								<h3>Vaction Tips</h3>
								<ul>
									<li>
										<a href="news.aspx">What to bring on the beach?</a>
									</li>
									<li>
										<a href="news.aspx">Planning Fun Activities</a>
									</li>
									<li>
										<a href="news.aspx">Diving Checklist</a>
									</li>
									<li>
										<a href="news.aspx">First Aid</a>
									</li>
									<li>
										<a href="news.aspx">How to Build a Sand Castle?</a>
									</li>
									<li>
										<a href="news.aspx">Tanning Tips</a>
									</li>
								</ul>
							</div>
							<div>
